					...
					if (Block.isSolid(x, y)){
						...
						if (surrounding.size() == 1){
							if (surrounding.contains(Block.getBlock(x + 1, y)) ||
									(y < MineFlat.world.getChunkHeight() - 1 &&
